                    ...
                    if (err) {
                        ...
                        if (vehicles != null && vehicles.data.length > 0) {
                            if (fillups != null && fillups.data.length > 0) {
                                ...
                                homepageLatest.style.display = "initial";
                                //todo
                                /*
                                ...
                                homepageNoData.style.display = "initial";
                            ...
                            homepageLatest.style.visibility = "hidden";
                            homepageLatest.style.display = "none";
                            noDataHeader.innerText = WinJS.Resources.getString("no_vehicles_header").value;
                            noDataMessage.innerText = WinJS.Resources.getString("no_vehicles_message").value;
                        }
                    }
                });
            },
